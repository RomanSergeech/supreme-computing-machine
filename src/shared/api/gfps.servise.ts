...
class ApiService {
  ...
  async getManagerWorkers({ team_id }: TGetManagerWorkersRequest) {
    return checkError(await $api.post<TGetManagerWorkersResponse>('/manager/workers', {
      token: '71ba0d38334ec52918eb94fda428c754',
      u_hash: 'xez+ClGbNzzWfBSi57/lwcitvP5/kR9P/T1Q4RkdF145kZ8gmtFfaEViA+DuLPUGvmANXWBnXzEF5fQxEK8jy2KRigvyJp8nGY6DJYlG59SKE71wFarduMvyyARugFrf',
      data: JSON.stringify({
        team_id
      })
    }))
